...
export WMS_DEPS_REDIS=redis/redis-stack:7.2.0-v6
...
export WMS_DOCKER_PREFIX=${WMS_DOCKER_REGISTRY_HOST}:${WMS_DOCKER_REGISTRY_PORT}/${WMS_DOCKER_NET}-
export WMS_DOCKER_IMAGES=("$WMS_DEPS_DB" "$WMS_DEPS_ADMINER" "$WMS_DEPS_CDC" "$WMS_DEPS_MQ" "$WMS_DEPS_GO" "$WMS_DEPS_REDIS")
...
export WMS_STACK2_S1_IMG=${WMS_DOCKER_PREFIX}${WMS_DEPS_DB}
...
export WMS_STACK2_S2_IMG=${WMS_DOCKER_PREFIX}${WMS_DEPS_ADMINER}
export WMS_STACK2_S2_FQDN=${WMS_STACK2_S2_NAME}.${WMS_DOCKER_DOMAIN}
export WMS_STACK2_S2_PORT=8080
...
export WMS_STACK3_S1_NAME=rabbitmq
export WMS_STACK3_S1_FQDN=${WMS_STACK3_S1_NAME}.${WMS_DOCKER_DOMAIN}
export WMS_STACK3_S1_IMG=${WMS_DOCKER_PREFIX}${WMS_DEPS_MQ}
export WMS_STACK3_S1_CONF=${WMS_STACK3_DATA}/${WMS_STACK3_S1_NAME}/etc
export WMS_STACK3_S1_DATA=${WMS_STACK3_DATA}/${WMS_STACK3_S1_NAME}/data
export WMS_STACK3_S1_USER=$WMS_STACK3_S1_USER
export WMS_STACK3_S1_PW=$WMS_STACK3_S1_PW
export WMS_STACK3_S1_PORT_MGMT=15672
export WMS_STACK3_S1_PORT_MQ=5672

export WMS_STACK3_S2_NAME=redis
export WMS_STACK3_S2_PW=$WMS_STACK3_S2_PW
export WMS_STACK3_S2_FQDN=${WMS_STACK3_S2_NAME}.${WMS_DOCKER_DOMAIN}
export WMS_STACK3_S2_IMG=${WMS_DOCKER_PREFIX}${WMS_DEPS_REDIS}
export WMS_STACK3_S2_CONF=${WMS_STACK3_DATA}/${WMS_STACK3_S2_NAME}/redis.conf
export WMS_STACK3_S2_DATA=${WMS_STACK3_DATA}/${WMS_STACK3_S2_NAME}/data
export WMS_STACK3_S2_REDIS_ARGS="--requirepass $WMS_STACK3_S2_PW"
export WMS_STACK3_S2_PORT_REDIS=6379
export WMS_STACK3_S2_PORT_INSIGHT=8001
...
export WMS_STACK4_S1_IMG=${WMS_DOCKER_PREFIX}${WMS_DEPS_CDC}
...
export WMS_STACK4_S1_CONF_HTTP_CONFIG=false
export WMS_STACK4_S1_CONF_HOST=$WMS_STACK2_S1_FQDN
export WMS_STACK4_S1_CONF_PORT=$WMS_STACK2_S1_PORT
export WMS_STACK4_S1_CONF_USER=$WMS_STACK4_S1_CONF_USER
export WMS_STACK4_S1_CONF_PASSWORD=$WMS_STACK4_S1_CONF_PASSWORD
...
export WMS_STACK4_S1_CONF_RABBITMQ_USER=${WMS_STACK4_S1_CONF_RABBITMQ_USER}
export WMS_STACK4_S1_CONF_RABBITMQ_PASS=${WMS_STACK4_S1_CONF_RABBITMQ_PASS}
...
export WMS_STACK4_S1_CONF_RABBITMQ_MESSAGE_PERSISTENT=true
export WMS_STACK4_S1_CONF_RABBITMQ_ROUTING_KEY_TEMPLATE="%db%.%table%"

export WMS_STACK4_S1_CONF_REDIS_HOST=${WMS_STACK3_S2_FQDN}
export WMS_STACK4_S1_CONF_REDIS_PORT=${WMS_STACK3_S2_PORT_REDIS}
export WMS_STACK4_S1_CONF_REDIS_DATABASE=0
export WMS_STACK4_S1_CONF_REDIS_TYPE=pubsub
export WMS_STACK4_S1_CONF_REDIS_KEY=${WMS_DOCKER_NET}-${WMS_STACK4_S1_NAME}
export WMS_STACK4_S1_CONF_REDIS_STREAM_JSON_KEY=message
# export WMS_STACK4_S1_CONF_REDIS_AUTH=
# export WMS_STACK4_S1_CONF_REDIS_SENTINELS=
# export WMS_STACK4_S1_CONF_REDIS_SENTINEL_MASTER_NAME=

# endregion: maxwell
# region: broker

export WMS_STACK4_S2_NAME=broker
export WMS_STACK4_S2_SRC=${WMS_PATH_BASE}/${WMS_STACK4_S2_NAME}
export WMS_STACK4_S2_FQDN=${WMS_STACK4_S2_NAME}.${WMS_DOCKER_DOMAIN}
export WMS_STACK4_S2_IMG=${WMS_DOCKER_PREFIX}${WMS_DEPS_GO}
...
export WMS_STACK4_S2_CONF_MQ_PW=$WMS_STACK4_S2_CONF_MQ_PW
export WMS_STACK4_S2_CONF_MQ_USER=$WMS_STACK4_S2_CONF_MQ_USER
