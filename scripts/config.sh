...
export WMS_STACK1_IMAGES=("$WMS_DEPS_DB" "$WMS_DEPS_ADMINER" "$WMS_DEPS_CDC" "$WMS_DEPS_MQ" "$WMS_DEPS_GO" "$WMS_DEPS_REDIS")
export WMS_STACK1_PREFIX=${WMS_DOCKER_REGISTRY_HOST}:${WMS_DOCKER_REGISTRY_PORT}/${WMS_DOCKER_NET}-
...
export WMS_STACK2_S1_IMG=${WMS_STACK1_PREFIX}-${WMS_DEPS_DB}
...
export WMS_STACK2_S2_IMG=${WMS_STACK1_PREFIX}-${WMS_DEPS_ADMINER}
...
export WMS_STACK3_S1_IMG=${WMS_STACK1_PREFIX}-${WMS_DEPS_MQ}
...
export WMS_STACK3_S2_PORT_REDIS=8302
export WMS_STACK3_S2_PORT_INSIGHT=8303
