...
export WMS_STACK4_S1_CONF=${WMS_PATH_WORKBENCH}/${WMS_STACK4_NAME}/config.properties
...
export WMS_STACK4_S1_CONF_RABBITMQ_EXCHANGE=${WMS_DOCKER_NET}-${WMS_DEPS_CDC}
